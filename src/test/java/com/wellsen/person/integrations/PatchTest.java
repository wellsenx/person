...
class PatchTest extends IntegrationTest {

  @Test
  void patchPersonAfterPost() throws MalformedURLException {
  ...
  @Test
  void patchNameAfterPost() throws MalformedURLException {
    Person wellsen = new Person("Wellsen", 39);
    ResponseEntity<Person> postResponse = template.postForEntity(
        new URL("http://localhost:" + port + "/persons").toString(),
        wellsen,
    ...
    assertEquals(kevin.getName(), response.getBody().getName());
    assertEquals(wellsen.getAge(), response.getBody().getAge());
  }

  @Test
  void patchAgeAfterPost() throws MalformedURLException {
    Person wellsen = new Person("Wellsen", 39);
    ResponseEntity<Person> postResponse = template.postForEntity(
        new URL("http://localhost:" + port + "/persons").toString(),
        wellsen,
    ...
    assertNotNull(response.getBody());
    assertEquals(id, response.getBody().getId());
    assertEquals(wellsen.getName(), response.getBody().getName());
    assertEquals(kevin.getAge(), response.getBody().getAge());
  }

  @Test
  void patchWithInvalidName() throws MalformedURLException {
    Person wellsen = new Person("Wellsen", 39);
    ResponseEntity<Person> postResponse = template.postForEntity(
        new URL("http://localhost:" + port + "/persons").toString(),
        wellsen,
  ...
  @Test
  void patchWithInvalidAge() throws MalformedURLException {
    Person wellsen = new Person("Wellsen", 39);
    ResponseEntity<Person> postResponse = template.postForEntity(
        new URL("http://localhost:" + port + "/persons").toString(),
        wellsen,
  ...
  @Test
  void patchWithInvalidNameAndAge() throws MalformedURLException {
    Person wellsen = new Person("Wellsen", 39);
    ResponseEntity<Person> postResponse = template.postForEntity(
        new URL("http://localhost:" + port + "/persons").toString(),
        wellsen,
  ...
  @Test
  void patchWithNoName() throws MalformedURLException {
    Person wellsen = new Person("Wellsen", 39);
    ResponseEntity<Person> postResponse = template.postForEntity(
        new URL("http://localhost:" + port + "/persons").toString(),
        wellsen,
  ...
  @Test
  void patchPersonToInvalidPath() throws MalformedURLException {
  ...
  @Test
  void patchToRoot() throws MalformedURLException {
    Person person = new Person("Wellsen", 39);
    HttpEntity<Person> entity = new HttpEntity<>(person);
